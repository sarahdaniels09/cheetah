          ...
          <div class="container">
              <div class="row">
                  <div class="contact col-md-3 col-xs-12 col-sm-12">
                      <a href="#" class="footer-logo"><img src="images/" alt="Footer Logo"></a>
                  </div>
                  <div class="contact col-md-3 col-xs-12 col-sm-12"><i class="flaticon-signs"></i>
                      <p>Address : 16 Rue de la Belle Borne Bât.6, 93290 Tremblay-en-France, France</h4>
                  </div>
                  <!-- <div class="contact col-md-3 col-xs-12 col-sm-12"><i class="flaticon-phone-call "></i>
                            <p>Phone Number :</p>
                            <h4>+33757906161</h4></div>-->
              ...
              <div class="row">
                  <div class="footer-sidebar footer-1 col-xs-12 col-sm-6 col-md-3">
                      <div class="widget widget_text">
                          <h4 class="widget-title">About CheetahMiles Logistics</h4>
                          <div class="textwidget">
                              <p>CheetahMiles Logistics Services is a global supplier of transport and logistics solutions. We have offices in more than 20 countries and an international network of partners and agents.</p>
                          </div>
                      </div>
                              ...
                              <div class="latest-project clearfix">
                                  <div class="fp-widget-thumb">
                                      <a class="widget-thumb" href="#">
                                          ...
                                          <img src="images/projects/fg1.jpg" alt="">
                                      </a>
                                  </div>
                              </div>
                              <div class="latest-project clearfix">
                                  <div class="fp-widget-thumb">
                                      <a class="widget-thumb" href="#">
                                          <i class="fa fa-link" aria-hidden="true"></i>
                                          <img src="images/projects/fg2.jpg" alt="">
                                      </a>
                                  </div>
                              </div>
                              <div class="latest-project clearfix">
                                  <div class="fp-widget-thumb">
                                      <a class="widget-thumb" href="#">
                                          <i class="fa fa-link" aria-hidden="true"></i>
                                          <img src="images/projects/fg3.jpg" alt="">
                                      </a>
                                  </div>
                              </div>
                              <div class="latest-project clearfix">
                                  <div class="fp-widget-thumb">
                                      <a class="widget-thumb" href="#">
                                          <i class="fa fa-link" aria-hidden="true"></i>
                                          <img src="images/projects/fg4.jpg" alt="">
                                      </a>
                                  </div>
                              </div>
                              <div class="latest-project clearfix">
                                  <div class="fp-widget-thumb">
                                      <a class="widget-thumb" href="#">
                                          <i class="fa fa-link" aria-hidden="true"></i>
                                          <img src="images/projects/fg5.jpg" alt="">
                                      </a>
                                  </div>
                              </div>
                              <div class="latest-project clearfix">
                                  <div class="fp-widget-thumb">
                                      <a class="widget-thumb" href="#">
                                          <i class="fa fa-link" aria-hidden="true"></i>
                                          <img src="images/projects/fg6.jpg" alt="">
                                      </a>
                                  </div>
                              </div>
                          </div>
      ...
      <div class="container">
          <div class="row">
              <div class="footer-copyright col-md-6 col-sm-12 col-sx-12">
                  <div class="site-info">Copyright @ 2021 <a href="index.html">CheetahMiles Logistics</a>, All Right Reserved </div>
              </div>
  ...
  <div class="primary-mobile-nav header-v1" id="primary-mobile-nav" role="navigation">
      ...
      <ul class="menu">
          ...
          <li><a href="app/login">SignIn</a></li>

          <li class="extra-menu-item menu-item-button-link">
              <a href="app/track" class="fh-btn btn">Track Your Shipment</a>
          </li>
      </ul>
  ...
  <script src="../unpkg.com/isotope-layout%403.0.6/dist/isotope.pkgd.min.html"></script>
  <!-- owl.carousel js -->
  ...
  <script type="text/javascript">
      $(function() {
          $('#WAButton').floatingWhatsApp({
              phone: '+33757906161', //WhatsApp Business phone number 
  ...
  <script type="text/javascript">
      ...
      (function() {
          ...
          s1.async = true;
          s1.src = 'https://embed.tawk.to/60281a46918aa261273e9c9e/1euead9tc';
          s1.charset = 'UTF-8';
