...
// *************************************************************************
    ...
    $address_order= $db->registro();
        ...
        if (isset($_POST["total_item"])) {           
            ...
            $db->query("DELETE FROM  customers_packages_detail WHERE order_id='".$order_id."'");
            $db->execute();
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input  onkeypress="return soloNumeros(event)"  type="text" class="form-control" name="price_purchase" id="price_purchase"  placeholder="<?php echo $lang['left67'] ?>"  required="required" value="<?php echo $row_order->price_purchase;?>">
                                    </div>
                                </div>
                            </div>
