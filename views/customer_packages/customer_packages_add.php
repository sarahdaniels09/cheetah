...
// *************************************************************************
    ...
    $userData = $user->getUserData();
        ...
        if (isset($_POST["create_invoice"])) {
            ...
            $db->bind(':order_no', trim($_POST["order_no"]));            
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 align-self-center">
                        <h4 class="page-title"><i class="ti-package" aria-hidden="true"></i> Register package</h4>
                    </div>
                </div>
            </div>
                                ...
                                <div class="form-row">   
                                    ...
                                    <div class="form-group col-md-6">
                                     ...
                                     <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group mb-3">                                            
                                            <input type="number" class="form-control" name="order_no" id="order_no" value="<?php echo $track;?>" onchange="validateTrackNumber(this.value);">
                                        </div>
