...
// *************************************************************************
    ...
    $userData = $user->getUserData();
        ...
        for ($count = 0; $count < $_POST["total_item"]; $count++) { 
            ...
            $insurance = floatval($_POST["insurance_value"]);
            $c_tariffs= floatval($_POST["tariffs_value"]);
            $tax= floatval($_POST["tax_value"]);
            $total_reexp= floatval($_POST["reexpedicion_value"]);
            $value_weight= floatval($_POST["price_lb"]);
            ...
            $total_reexpedicion = 0;

            $weight_item= trim($_POST["order_item_weight"][$count]);
            $length_item= trim($_POST["order_item_length"][$count]);
            $width_item= trim($_POST["order_item_width"][$count]);
            $height_item = trim($_POST["order_item_height"][$count]);  
            $declared_value_item = trim($_POST["order_item_declared_value"][$count]);  
            ...
            $precio_total=$calculate_weight* $value_weight;
            ...
            if($sumador_total> $core->min_cost_tax){
                ...
                $total_impuesto= $sumador_total * $tax/100;
            }
            ...
            $total_descuento= $sumador_total *$discount /100;
            $total_peso =$sumador_libras + $sumador_volumetric;

            $total_seguro= $sumador_total * $insurance /100;

            $total_impuesto_aduanero= $total_peso * $c_tariffs;

            $total_envio = ($sumador_total-$total_descuento)+ $total_impuesto + $total_seguro+ $total_impuesto_aduanero+$total_valor_declarado + $total_reexp;
        ...
        $db->bind(':declared_value',  floatval($declared_value_tax));
        $db->bind(':total_declared_value',  floatval($total_valor_declarado));

        $db->bind(':tax_value', $tax);
        $db->bind(':tax_insurance_value', $insurance);
        $db->bind(':tax_custom_tariffis_value', $c_tariffs);
        $db->bind(':value_weight',  $value_weight);
        $db->bind(':volumetric_percentage',  $meter);
        $db->bind(':sub_total',  $sumador_total);
        $db->bind(':tax_discount',  $discount);
        $db->bind(':total_reexp',  $total_reexp);
        $db->bind(':total_tax_discount',  $total_descuento);
        $db->bind(':total_tax_insurance',  $total_seguro);
        $db->bind(':total_tax_custom_tariffis',  $total_impuesto_aduanero);
        $db->bind(':total_weight',  floatval($total_peso));
        $db->bind(':total_tax', $total_impuesto);
        $db->bind(':total_order',  $total_envio);
        ...
        $subject="a new package has been registered in your locker, tracking number $fullshipment";



        $email_template =getEmailTemplates(21);
        ...
        $db->bind(':sender_zip_code',  $sender_zip_code);
          ...
          if($success){
                ...
                header("location:customer_packages_multiple.php?success=1");
            }else{

                header("location:customer_packages_multiple.php?success=0");
            }
        ?>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                ?>
                                    ...
                                    <div class="col-md-12 ">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append input-sm">
                                                <button  disabled id="add_address_sender" data-type_user="user_customer"  data-toggle="modal" data-target="#myModalAddRecipientAddresses" type="button" class="btn btn-info"><i class="fa fa-plus"></i></button>
                                            </div>
                              ...
                              <!--   <input type="text" name="sender_address" id="sender_address" placeholder="sender_address">
                                <input type="text" name="sender_country" id="sender_country" placeholder="sender_country">
                                <input type="text" name="sender_city" id="sender_city" placeholder="sender_city">
                                <input type="text" name="sender_zip_code" id="sender_zip_code" placeholder="sender_zip_code">
 -->
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input  type="text" class="form-control" name="tracking_purchase" id="tracking_purchase" placeholder="Example: 009785454545554"  required="required">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="provider_purchase" id="provider_purchase" placeholder="<?php echo $lang['left65'] ?>" required="required">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input  onkeypress="return soloNumeros(event)"  type="text" class="form-control" name="price_purchase" id="price_purchase"  placeholder="<?php echo $lang['left67'] ?>"  required="required">
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    function validateTrackNumber(value){
