                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div><span> Pickup</span>
                                                <h3 class="font-medium m-b-0">
                                                    ...
                                                    $db->query("SELECT COUNT(*) as total FROM add_order WHERE is_pickup=1 and month(order_date)='$month' AND year(order_date)='$year'");
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div><span>Pickup rejected</span>
                                                <h3 class="font-medium m-b-0">
                                                    ...
                                                    $db->query("SELECT COUNT(*) as total FROM add_order WHERE is_pickup=1 and status_courier=12 and month(order_date)='$month' AND year(order_date)='$year'");
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div><span>Pickup cancelled</span>
                                                <h3 class="font-medium m-b-0">
                                                    ...
                                                    $db->query("SELECT COUNT(*) as total FROM add_order WHERE is_pickup=1 and status_courier=21 and month(order_date)='$month' AND year(order_date)='$year'");
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div><span>Pickup Delivered</span>
                                                <h3 class="font-medium m-b-0">
                                                    ...
                                                    $db->query("SELECT COUNT(*) as total FROM add_order WHERE status_courier=8 and  is_pickup=1 and month(order_date)='$month' AND year(order_date)='$year'");
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div><span>Current month's income</span>
                                                <h3 class="font-medium m-b-0">
                                                    ...
                                                    $db->query("SELECT IFNULL(SUM(total_order), 0) as total FROM add_order WHERE status_courier!=21 and is_pickup=1 and month(order_date)='$month' AND year(order_date)='$year'");
...
$(document).ready(function() {
    ...
    $.ajax({
        url:'./ajax/dashboard/pickup/load_graphics_pickup_ajax.php',
        type: "POST",
        dataType: "json",
