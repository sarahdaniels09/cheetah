                                ...
                                <div class="row">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div><span>Packages Registered Pending</span>
                                                <h3 class="font-medium m-b-0">
                                                    ...
                                                    $db->query('SELECT COUNT(*) as total FROM customers_packages where status_invoice = 2');
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div><span>Packages Registered payment verification</span>
                                                <h3 class="font-medium m-b-0">
                                                    ...
                                                    $db->query('SELECT COUNT(*) as total FROM customers_packages where status_invoice = 3');
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div><span>Packages Registered paid</span>
                                                <h3 class="font-medium m-b-0">
                                                    ...
                                                    $db->query('SELECT COUNT(*) as total FROM customers_packages where status_invoice = 1');
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div><span>Packages Pre Alerts</span>
                                                <h3 class="font-medium m-b-0">
                                                    ...
                                                    $db->query('SELECT COUNT(*) as total FROM customers_packages where is_prealert=1');
                                   ...
                                   <!--  <div class="col-md-4 col-lg-12">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div><span>Packages registered Delivered</span>
                                                <h3 class="font-medium m-b-0">
                                                    <?php 
                                                    ...
                                                    $db->query("SELECT COUNT(*) as total FROM customers_packages WHERE status_courier=8 and month(order_date)='$month' AND year(order_date)='$year'");
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div><span>Current month's income</span>
                                                <h3 class="font-medium m-b-0">
                                                    ...
                                                    $db->query("SELECT IFNULL(SUM(total_order), 0) as total FROM customers_packages WHERE status_courier!=21 and  month(order_date)='$month' AND year(order_date)='$year'");
