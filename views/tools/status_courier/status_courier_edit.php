...
// *************************************************************************
	...
	if (isset($_GET['id'])) {
		$data= getStatusCourierEdit($_GET['id']);
	}

	if (!isset($_GET['id']) or $data['rowCount']!=1){
		redirect_to("status_courier_list.php");
	}
			 ...
			 <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <span><?php echo $lang['tools-config61'] ?> | <?php echo $lang['tools-statuscourier12']; ?></span>
						...
						<div class="card">
							<div class="card-body">
								...
								<form class="form-horizontal form-material" id="update_data" name="update_data" method="post">
									<header><?php echo $lang['tools-statuscourier1'] ?> <span><?php echo $lang['tools-statuscourier2'] ?> <i class="icon-double-angle-right"></i> <?php echo $row_off->mod_style;?></span></header> <br><br>
									<section>
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label for="firstName1"><?php echo $lang['tools-statuscourier1'] ?></label>
													<input type="text" class="form-control" name="mod_style" id="mod_style" value="<?php echo $row_off->mod_style;?>" placeholder="<?php echo $lang['tools-statuscourier1'] ?>">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label for="lastName1"><?php echo $lang['tools-statuscourier3'] ?></label>
													<input type="text" class="form-control" name="detail" id="detail" value="<?php echo $row_off->detail;?>" placeholder="<?php echo $lang['tools-statuscourier3'] ?>">
												</div>
											</div>			
										</div>
