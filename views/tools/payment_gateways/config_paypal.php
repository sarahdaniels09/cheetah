...
<body>
						...
						<div class="right-part mail-list bg-white">
							<div class="p-15 b-b">
								<div class="d-flex align-items-center">
									<div>
										<span>Payment Gateways | PayPal</span>
									</div>
										...
										<div class="col-12">
											<div class="card-body">
												...
												<form class="form-horizontal form-material" id="save_data" name="save_data" method="post">
													<header><b>PayPal settings</b></header> <br><br>
													<section>
														<div class="row">
															<div class="col-md-12">
																<div class="form-group">
																	<label for="firstName1">Client ID</label>
																	<input type="text" class="form-control" name="client_id" id="client_id" placeholder="Client ID PayPal" value="<?php echo $core->paypal_client_id;?>">
																</div>
															</div>
	...
	<script src="dataJs/paypal_config.js"></script>   
</body>
