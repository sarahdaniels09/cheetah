...
// *************************************************************************
	...
	if (isset($_GET['id'])) {
		$data= getPaymentMethod2Edit($_GET['id']);
	}

	if (!isset($_GET['id']) or $data['rowCount']!=1){
		redirect_to("payment_methods_list.php");
	}
						...
						<div class="card">
							<div class="card-body">
								...
								<form class="form-horizontal form-material" id="update_data" name="update_data" method="post">
									<header><?php echo $lang['tools-methodpay1'] ?> <span><?php echo $lang['tools-methodpay2'] ?> <i class="icon-double-angle-right"></i> <?php echo $row_off->label;?></span></header> <br><br>
									<section>
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label for="firstName1"><?php echo $lang['tools-methodpay1'] ?></label>
													<input type="text" class="form-control" name="met_payment" value="<?php echo $row_off->label;?>" placeholder="<?php echo $lang['tools-methodpay1'] ?>">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label for="lastName1">Days</label>
													<input type="text" class="form-control" name="detail" value="<?php echo $row_off->days;?>" placeholder="Days">
												</div>
											</div>
										</div>
									</section>	
