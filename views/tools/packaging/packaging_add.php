						...
						<div class="card">
							<div class="card-body">
								...
								<form class="form-horizontal form-material" id="save_data" name="save_data" method="post">
									<header><?php echo $lang['tools-packaging6'] ?> <span><?php echo $lang['tools-packaging7'] ?></span></header> <br><br>
									<section>
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<label for="firstName1"><?php echo $lang['tools-packaging6'] ?></label>
													<input type="text" class="form-control" name="name_pack" id="name_pack" placeholder="<?php echo $lang['tools-packaging6'] ?>">
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<label for="lastName1"><?php echo $lang['tools-packaging8'] ?></label>
													<textarea class="form-control" rows="2" type="text" name="detail_pack" id="detail_pack" placeholder="<?php echo $lang['tools-packaging8'] ?>"></textarea>
												</div>
											</div>
										</div>
									</section>	
