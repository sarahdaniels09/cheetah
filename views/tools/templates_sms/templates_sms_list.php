										...
										<div class="card-body">
											...
											<div class="col-md-4 pull-right m-b-20">
						  				      ...
						  				      <div class="input-group input-group">
							                      ...
							                      <input type="text" name="search" id="search" class="form-control input-sm float-right" placeholder="search Template"  onkeyup="load(1);">
        ...
        new Messi(text, {
            ...
            buttons: [{
			  ...
			  callback: function (val) {
				  $.ajax({
					  type: 'post',
            			url: "ajax/tools/templates_sms/active_inative_template_sms_ajax.php",
					  data: {
						  active:'1',
						  id: id,
					  },
