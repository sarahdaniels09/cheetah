								...
								<tbody>
									...
									<tr>
										...
										<td class="text-center">
											<a href="tools.php?list=smstwilio&id=<?php echo $row->id;?>" data-toggle="tooltip" data-original-title="<?php echo $lang['tools-twilio8'] ?>"><i class="ti-pencil" aria-hidden="true"></i></a> 											
										</td>
									</tr>
									<?php endforeach;?>
								</tbody>
							...
							<table id="dt-material-checkbox" class="table table-condensed table-hover table-striped">
								...
								<tbody>
									...
									<tr>
										...
										<td class="text-center">
											<a href="tools.php?list=smsnexmo&id=<?php echo $row->id;?>"data-toggle="tooltip" data-original-title="<?php echo $lang['tools-nexmo8'] ?>"><i class="ti-pencil" aria-hidden="true"></i></a> 											
										</td>
									</tr>
									<?php endforeach;?>
								</tbody>
        ...
        new Messi(text, {
            ...
            buttons: [{
			  ...
			  callback: function (val) {
				  $.ajax({
					  type: 'post',
            			url: "ajax/tools/active_inative_twilo_ajax.php",
					  data: {
						  active_twi:'1',
						  id: uid,
					  },
        ...
        new Messi(text, {
            ...
            buttons: [{
			  ...
			  callback: function (val) {
				  $.ajax({
					  type: 'post',
            			url: "ajax/tools/active_inative_nexmo_ajax.php",
					  data: {
						  id: uid,
						  active_nex:'1'
					  },
