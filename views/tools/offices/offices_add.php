						...
						<div class="card">
							<div class="card-body">
								...
								<form class="form-horizontal form-material" id="save_data" name="save_data" method="post">
									<header><?php echo $lang['tools-office9'] ?> <span><?php echo $lang['tools-office8'] ?></span></header> <br><br><br>
									<section>
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													<label for="firstName1"><?php echo $lang['tools-office9'] ?></label>
													<input type="text" class="form-control" name="name_off" id="name_off" placeholder="<?php echo $lang['tools-office9'] ?>">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label for="lastName1"><?php echo $lang['tools-office23'] ?></label>
													<input type="text" class="form-control" name="code_off" id="code_off" placeholder="<?php echo $lang['tools-office23'] ?>">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label for="lastName1"><?php echo $lang['tools-office10'] ?></label>
													<input type="text" class="form-control" name="address" id="address" placeholder="<?php echo $lang['tools-office10'] ?>">
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="city"  id="city" placeholder="<?php echo $lang['tools-office11'] ?>">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label for="lastName1"><?php echo $lang['tools-office12'] ?></label>
													<input type="text" class="form-control" name="phone_off" id="phone_off" placeholder="<?php echo $lang['tools-office12'] ?>">
												</div>
											</div>
										</div>
									</section>
