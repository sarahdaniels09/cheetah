...
require_once('helpers/querys.php');
	...
	if (isset($_GET['id'])) {
		...
		$row= getEmailTemplates($_GET['id']);
	}


if (!isset($_GET['id']) or $row==null){

		redirect_to("templates_email.php");
	}
			...
			<div class="col-12">
				<div class="card-body">
					<form class="form-horizontal form-material" id="save_data" name="save_data" method="post">
						<header><?php echo $lang['tools-template1'] ?><span><?php echo $lang['tools-template2'] ?> <i class="icon-double-angle-right"></i> <?php echo $row->name;?></span></header> <br><br>
						<section>
							<div class="row">
								<div class="col-md-6">
