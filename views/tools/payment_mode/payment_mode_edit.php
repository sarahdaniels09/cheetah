...
// *************************************************************************
	...
	if (isset($_GET['id'])) {
		$data= getPaymentMethodEdit($_GET['id']);
	}

	if (!isset($_GET['id']) or $data['rowCount']!=1){
		redirect_to("payment_method_list.php");
	}
						...
						<div class="card">
							<div class="card-body">
								...
								<form class="form-horizontal form-material" id="update_data" name="update_data" method="post">
									<header><?php echo $lang['tools-methodpay1'] ?> <span><?php echo $lang['tools-methodpay2'] ?> <i class="icon-double-angle-right"></i> <?php echo $row_off->met_payment;?></span></header> <br><br>
									<section>
										<div class="row">
											<div class="col-md-6">
