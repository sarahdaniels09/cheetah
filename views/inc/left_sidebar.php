                ...
                <nav class="sidebar-nav idebar-collapse">
				 <?php if($userData->userlevel == 9){?>
                       ...
                       <li class="p-15 m-t-10"><a href="courier_add.php" class="btn btn-block create-btn text-white no-block d-flex align-items-center"><i class="ti-package"></i> <span class="hide-menu m-l-5"> <?php echo $lang['left1'] ?> </span> </a></li>
						...
						<li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-cart-outline"></i><span class="hide-menu"><?php echo $lang['leftnew01'] ?></span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
								...
								<li class="sidebar-item"><a href="customer_packages_add.php" class="sidebar-link"><i class="ti-package"></i><span class="hide-menu"> <?php echo $lang['create_customer_packages'] ?> </span></a></li>

								<li class="sidebar-item"><a href="customer_packages_multiple.php" class="sidebar-link"><i class="ti-package" style="color:#f62d51"></i><span class="hide-menu"> <?php echo $lang['createpackages_multiple'] ?> </span></a></li>								
						...
						<li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-package-variant"></i><span class="hide-menu"> <?php echo $lang['shipment'] ?></span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
								...
								<li class="sidebar-item"><a href="dashboard_admin_shipments.php" class="sidebar-link"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu"> <?php echo $lang['leftnew04'] ?></span></a></li>

								<li class="sidebar-item"><a href="courier_add.php" class="sidebar-link"><i class="mdi mdi-cube-send" style="color:#f62d51"></i><span class="hide-menu"> <?php echo $lang['createshipment'] ?> </span></a></li>

								<li class="sidebar-item"><a href="courier_add_multiple.php" class="sidebar-link"><i class="mdi mdi-cube-send" style="color:#f62d51"></i><span class="hide-menu"> <?php echo $lang['createshipment_multiple'] ?> </span></a></li>								
						...
						<li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fas fas fa-boxes" style="color:#6610f2"></i><span class="hide-menu"> <?php echo $lang['conso-lidate'] ?></span></a>
                            ...
                            <li class="sidebar-item"><a href="dashboard_admin_consolidated.php" class="sidebar-link"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu"> <?php echo $lang['leftnew06'] ?></span></a></li>
								...
								<li class="sidebar-item"><a href="consolidate_add.php" class="sidebar-link"><i class="fas fa-cubes" style="color:#975EF7"></i><span class="hide-menu"> <?php echo $lang['left11'] ?> </span></a></li>
						...
						<li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fas fa-hand-holding-usd" style="color:#2962FF"></i><span class="hide-menu"> <?php echo $lang['left25'] ?></span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
								...
								<li class="sidebar-item"><a href="accounts_receivable.php" class="sidebar-link"><i class="mdi mdi-clock-fast"></i><span class="hide-menu"> <?php echo $lang['accounts_receivable'] ?> </span></a></li>

								<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark" href="global_payments_gateways.php" aria-expanded="false"><i class="fas fa-dollar-sign"></i><span class="hide-menu"><?php echo $lang['leftnew03'] ?> </span></a></li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-account-multiple-plus"></i><span class="hide-menu"> <?php echo $lang['left608'] ?></span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
								<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark" href="customers_list.php" aria-expanded="false"><i class="mdi mdi-account-multiple-plus"></i><span class="hide-menu"> <?php echo $lang['left23'] ?> </span></a></li>

								<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark" href="drivers_list.php" aria-expanded="false"><i class="mdi mdi-car"></i><span class="hide-menu"> <?php echo $lang['left24'] ?></span></a></li>	
							</ul>
                        </li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark" href="tools.php" aria-expanded="false"><i class="mdi mdi-settings" style="color:#0092FF"></i><span class="hide-menu"> <?php echo $lang['tool'] ?> </span></a>
                        </li>


                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fas fas fa-dolly" style="color:#C1FF00"></i><span class="hide-menu"> <?php echo $lang['leftshipping'] ?></span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
								<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark" href="taxesadnfees.php" aria-expanded="false"><i class="mdi mdi-percent"></i><span class="hide-menu"> <?php echo $lang['left29'] ?> </span></a>
								</li>

								<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark" href="track_invoice.php" aria-expanded="false"><i class="mdi mdi-truck"></i><span class="hide-menu"> <?php echo $lang['left600'] ?></span></a></li>


								<li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"> <i class="ti ti-list" style="color:#FF6D00"></i> <span class="hide-menu"> <?php echo $lang['left606'] ?></span></a>
									<ul aria-expanded="false" class="collapse  first-level">
										<li class="sidebar-item"><a class="sidebar-link waves-effect waves-dark" href="offices_list.php" ><i class="ti ti-arrow-right"></i><span class="hide-menu"> <?php echo $lang['officegroup'] ?></span></a>
										</li>


										<li class="sidebar-item"><a class="sidebar-link waves-effect waves-dark" href="branchoffices_list.php"><i class="ti ti-arrow-right"></i><span class="hide-menu"> <?php echo $lang['left30'] ?></span></a>
										</li>
										<li class="sidebar-item"><a class="sidebar-link waves-effect waves-dark" href="courier_company_list.php"><i class="ti ti-arrow-right"></i><span class="hide-menu"> <?php echo $lang['left31'] ?></span></a>
										</li>
										<li class="sidebar-item"><a class="sidebar-link waves-effect waves-dark" href="delivery_time_list.php"><i class="ti ti-arrow-right"></i><span class="hide-menu"> <?php echo $lang['left609'] ?></span></a>
										</li>
										<li class="sidebar-item"><a class="sidebar-link waves-effect waves-dark" href="shipping_mode_list.php"><i class="ti ti-arrow-right"></i><span class="hide-menu"> <?php echo $lang['shipmode'] ?></span></a>
										</li>
										<li class="sidebar-item"><a class="sidebar-link waves-effect waves-dark" href="status_courier_list.php"><i class="ti ti-arrow-right"></i><span class="hide-menu"> <?php echo $lang['stylestatus'] ?></span></a>
										</li>
										<li class="sidebar-item"><a class="sidebar-link waves-effect waves-dark" href="payment_mode_list.php"><i class="ti ti-arrow-right"></i><span class="hide-menu"> <?php echo $lang['paymode'] ?></span></a>
										</li>
										<li class="sidebar-item"><a class="sidebar-link waves-effect waves-dark" href="packaging_list.php" ><i class="ti ti-arrow-right"></i><span class="hide-menu">  <?php echo $lang['packatype'] ?></span></a>
										</li>
										<li class="sidebar-item"><a class="sidebar-link waves-effect waves-dark" href="category_list.php"><i class="ti ti-arrow-right"></i><span class="hide-menu"> <?php echo $lang['itemcategory'] ?></span></a></li>

										<li class="sidebar-item"><a class="sidebar-link waves-effect waves-dark" href="payment_methods_list.php"><i class="ti ti-arrow-right"></i><span class="hide-menu"> <?php echo $lang['payment_methods'] ?></span></a></li>
									</ul>
								</li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fas fa-users" style="color:#FFDA00"></i><span class="hide-menu"> <?php echo $lang['left28'] ?></span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
								<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark" href="users_list.php" aria-expanded="false"><i class="mdi mdi-account-switch"></i><span class="hide-menu"> <?php echo $lang['usermanage'] ?> </span></a></li>

								<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark" href="users_add.php" aria-expanded="false"><i class="mdi mdi-account-multiple-plus" style="color:#BF00FF"></i><span class="hide-menu"> <?php echo $lang['usermanagecreate'] ?> </span></a></li>

								<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark" href="newsletter.php" aria-expanded="false"><i class="mdi mdi-email-outline"></i><span class="hide-menu"> <?php echo $lang['newsletter'] ?></span></a></li>	
							</ul>
                        </li>
                       ...
                       <li class="p-15 m-t-10"><a href="courier_add.php" class="btn btn-block create-btn text-white no-block d-flex align-items-center"><i class="ti-package"></i> <span class="hide-menu m-l-5"> <?php echo $lang['left1'] ?> </span> </a></li>
						...
						<li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-package-variant"></i><span class="hide-menu"> <?php echo $lang['shipment'] ?></span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
								...
								<li class="sidebar-item"><a href="courier_add_multiple.php" class="sidebar-link"><i class="ti-package" style="color:#f62d51"></i><span class="hide-menu"> <?php echo $lang['createshipment_multiple'] ?> </span></a></li>								
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-cube-send"></i><span class="hide-menu"> Pickup</span></a>
							...
							<li class="sidebar-item"><a href="dashboard_admin_pickup.php" class="sidebar-link"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu"> <?php echo $lang['leftnew05'] ?> </span></a></li>
								...
								<li class="sidebar-item"><a href="pickup_add_full.php" class="sidebar-link"><i class="mdi mdi-clock-fast" style="color:#f62d51"></i><span class="hide-menu"> <?php echo $lang['left702'] ?> </span></a></li>
								<?php 
					...
					<?php }else if($userData->userlevel == 1){?>
						...
						<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark" href="users_edit.php?user=<?php echo $userData->id;?>" aria-expanded="false"><i class="mdi mdi-account"></i><span class="hide-menu"> <?php echo $lang['left43'] ?> </span></a></li>
