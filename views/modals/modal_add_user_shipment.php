	<!-- Modal -->
	<div class="modal fade" id="myModalAddUser" tabindex="-1" role="dialog" aria-labelledby="modal_add_user_title">
	  <div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
		  <div class="modal-header">
				<h4 class="modal-title" id="modal_add_user_title"></h4>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="country_modal_user"  id="country_modal_user" placeholder="<?php echo $lang['user_manage12'] ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="city_modal_user" name="city_modal_user" placeholder="<?php echo $lang['user_manage13'] ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
