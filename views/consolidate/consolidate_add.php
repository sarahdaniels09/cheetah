...
// *************************************************************************
    ...
    $db= new Conexion;
        ...
        if (isset($_POST["create_invoice"])) {
            ...
            $next_order=$core->consolidate_track(); 
            ...
            $email_template =getEmailTemplates(1);
                ...
                if(isset($_POST['notify_whatsapp_sender']) && $_POST['notify_whatsapp_sender']==1){
                 ...
                 if(isset($_POST['notify_whatsapp_receiver']) && $_POST['notify_whatsapp_receiver']==1){
                    ...
                    if($core->twilio_sid !=null && $core->twilio_token !=null && $core->twilio_number !=null){                    
                        ...
                        $db->query("SELECT * FROM users where id= '".$_POST["receiver_id"]."'"); 
...
<body>
    ...
    <div id="main-wrapper">
        ...
        <?php $track = $core->consolidate_track();?>
...
<script type="text/javascript">
        ...
        function cal_final_total(){
          ...
          total_envio =(sumador_total-total_descuento) +total_seguro+total_impuesto + total_impuesto_aduanero + reexpedicion_value;
