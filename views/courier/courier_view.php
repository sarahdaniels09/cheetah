                            ...
                            <div class="card-body"> 
                                        ...
                                        <div class="btn-group pull-right">
                                            ...
                                            <div class="dropdown-menu scrollable-menu">
                                                ...
                                                <?php if ($row_order->status_invoice ==2) {?>
                                                    ...
                                                    <a 
                                                        class="dropdown-item" 
                                                        href="add_payment_gateways_courier.php?id_order=<?php echo $row_order->order_id;?>">
                                                ...
                                                <?php if ($userData->userlevel !=1) {?>
                                                    ...
                                                    data-id="<?php echo $row_order->order_id;?>"
                                                    data-customer="<?php echo $row_order->sender_id;?>"                                         
                                            ...
                                            <?php if ($row_order->order_incomplete ==1) {?> 
                                                ...
                                                data-order="<?php echo $row_order->order_prefix.$row_order->order_no;?>"
                                    ...
                                    <div class="col-md-6  pull-right">
                                        <div class="btn-group pull-right">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                ><i style="color:#f62d51" class="fas fa-times-circle"></i>&nbsp;Cancel pickup</a>
                                ...
                                <div class="row">
                                   ...
                                   <div class="col-md-4">
                                        <div class="pull-left">                                        
                                            <h5> &nbsp;<b>Agency</b></h5>
                                            <p class="text-muted  m-l-5"><?php if($branchoffices!=null){echo $branchoffices->name_branch;}?></p>
                                    ...
                                    <div class="col-md-4">
                                        <div class="pull-left">                                        
                                            <h5> &nbsp;<b>Office</b></h5>
                                            <p class="text-muted  m-l-5"><?php if($offices!=null){echo $offices->name_off;}?></p>                                         
                                        </div>
                                ...
                                <div class="row">
                                   ...
                                   <div class="col-md-4">
                                        <div class="pull-left">                                        
                                            ...
                                            <p class="text-muted  m-l-5"><?php if($delivery_time!=null){ echo $delivery_time->delitime;} ?></p>                                       
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="pull-left">                                        
                                            ...
                                            <p class="text-muted  m-l-5"><?php if($courier_com!=null){echo $courier_com->name_com;} ?></p>

                                            <h5> &nbsp;<b>Shipping mode</b></h5>
                                            <p class="text-muted  m-l-5"><?php if($order_service_options!=null){ echo $order_service_options->ship_mode;} ?></p>                                       
                                        </div>
                                    ...
                                    <div class="col-md-12 pt-4">
                                        <div class="pull-left">                                        
                                            ...
                                            <b class="text-danger  m-l-5"><?php if($row_order->reason_cancel!=null){echo $row_order->reason_cancel;} ?></b>
                               ...
                               if($order_){                          
                                   ...
                                   if ($order_->status==='COMPLETED' || $order_->status==='succeeded' || $order_->status==='success' ){$text_status_payment='Completed';$label_class_payment="label-success";


                                    }else{

                                        $text_status_payment=$order_->status;$label_class_payment="label-warning";
                               ...
                               <div class="row">
                                   ...
                                   <br>
                                        ...
                                        <div class="pull-left">                                        
                                            <h5> &nbsp;<b>Notes</b></h5>
                                            <b class="text-muted  m-l-5"><?php if($row_order->notes!=null){echo $row_order->notes;} ?></b>
