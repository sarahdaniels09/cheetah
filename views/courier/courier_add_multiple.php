        ...
        // SAVE ADDRESS FOR Shipments
         ...
         $db->query("
          ...
          if($success){
                ...
                header("location:courier_add_multiple.php?success=1");
            }else{

                header("location:courier_add_multiple.php?success=0");
            }
        ?>
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 align-self-center">
                        <h4 class="page-title"><i class="ti-package" aria-hidden="true"></i> Register multiple shipments</h4>
                    </div>
                </div>
            </div>
