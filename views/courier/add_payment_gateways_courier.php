...
// *************************************************************************
    ...
    if (isset($_GET['id_order'])) {
        $data= getCourierPrint($_GET['id_order']);
    }
     ...
     <script type="text/javascript">
        ...
        function addPaymentPayPalSuccess(details){
            ...
            $.ajax({
                ...
                url:'./ajax/courier/add_payment_paypal_method_ajax.php?order_id=<?php echo $_GET['id_order'];?>&track_order=<?php echo $track_order; ?>&customer=<?php echo $row_order->sender_id; ?>',
                method:'post',
                data: details,                       
...
document.querySelector("button").disabled = true;
    ...
    fetch("./ajax/courier/add_payment_stripe_method_ajax.php", {
      method: "POST",
      headers: {
...
var loading = function(isLoading) {
 ...
 function addPaymentStripeSuccess(details){
    ...
    $.ajax({
        ...
        url:'./ajax/courier/add_payment_stripe_method_success_ajax.php?order_id=<?php echo $_GET['id_order'];?>&track_order=<?php echo $track_order; ?>&customer=<?php echo $row_order->sender_id; ?>',
        method:'post',
        data: details,                       
        success:function(data){
...
function redirect() {
    window.location = "courier_view.php?id=<?php echo $_GET['id_order']; ?>";
}
...
$( "#add_charges" ).submit(function( event ) {
    ...
    $.ajax({
        type: "POST",
        url: "./ajax/courier/courier_add_payment_doc_ajax.php?order_id=<?php echo $_GET['id_order']; ?>",
        data: data,
...
<script type="text/javascript">
    ...
    function addPaymentPaystackSuccess(details){
        ...
        $.ajax({
            ...
            url:'./ajax/courier/add_payment_paystack_method_success_ajax.php?order_id=<?php echo $_GET['id_order'];?>&track_order=<?php echo $track_order; ?>&customer=<?php echo $row_order->sender_id; ?>&firstname='+firstname+'&lastname='+lastname,
            method:'post',
            data: details,                       
            success:function(data){
