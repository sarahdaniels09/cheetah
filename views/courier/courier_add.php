...
// *************************************************************************
        ...
        if (isset($_POST["create_invoice"])) {
            ...
            if (count($_FILES['filesMultiple']['name'])>0 && $_FILES['filesMultiple']['tmp_name'][0]!='') { 
                ...
                { 
                    ...
                    insertOrdersFiles($order_id, $target_file, $image_name, date("Y-m-d H:i:s"), '0');
                ...
                if(isset($_POST['notify_whatsapp_sender']) && $_POST['notify_whatsapp_sender']==1){
                 ...
                 if(isset($_POST['notify_whatsapp_receiver']) && $_POST['notify_whatsapp_receiver']==1){
                    ...
                    if($core->twilio_sid !=null && $core->twilio_token !=null && $core->twilio_number !=null){                    
                        ...
                        $db->query("SELECT * FROM users where id= '".$_POST["recipient_id"]."'"); 
            ...
            $db->bind(':order_id',  $order_id);
            $db->bind(':user_id',  $_SESSION['userid']);
            $db->bind(':action','create shipment'); 
            ...
            $db->bind(':user_id',  $_SESSION['userid']);
            $db->bind(':order_id',  $order_id);       
            $db->bind(':notification_description','There is a new shipment, please check it');           
    ...
    // var_dump(getUsersAdminEmployees());
                            ...
                            <div class="card-body"> 
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                ...
                                                <select class="custom-select input-sm hide" id="code_prefix_select" name="code_prefix2" required="">
                                ...
                                <!-- <?php }else if($user->access_level='Employee'){?>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="inputname" class="control-label col-form-label"><?php echo $lang['add-title14'] ?></label>
                                        <div class="input-group mb-3">
                                            <input class="form-control" name="origin_off" value="<?php echo $user->name_off; ?>" readonly required>
                                        </div>
                                    </div>
...
<script type="text/javascript">
        ...
        function cal_final_total(){
          ...
          console.log(reexpedicion_value);
