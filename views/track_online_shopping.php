...
if (isset($_GET['order_track'])) {
    ...
    $results= getCustomersPackagesTrack($_GET['order_track']);
...
$db->query("SELECT SUM(order_item_length) as total0 from customers_packages_detail where order_id='".$track->order_id."'");
$db->execute();
$row0 =$db->registro();
...
$db->query("SELECT SUM(order_item_width) as total1 from customers_packages_detail where order_id='".$track->order_id."'");
$db->execute();
$row1 =$db->registro();
...
$db->query("SELECT SUM(order_item_height) as total2 from customers_packages_detail where order_id='".$track->order_id."'");
$db->execute();
$row2 =$db->registro();
...
$db->query("SELECT * FROM customers_packages_detail WHERE order_id='".$track->order_id."'"); 
							...
							<br><br><br>
								<div class="row">
									...
									<div class="col-md-2">
										...
										<a class="btn btn-success btn-sm  rounded" target="blank" href="print_customer_package_track.php?id=<?php echo $track->order_id;?>"><i style="color:white" class="ti-printer"></i>&nbsp;<?php echo $lang['toolprint'] ?></a>
