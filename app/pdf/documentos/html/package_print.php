    ...
    <br>
        ...
        <table id="meta" style="width: 100%;  border-collapse: collapse;">
            <tr style="border: 1px solid black">
                ...
                <td  style="border-bottom:  2px; border-top:  2px; border-left: 2px" class="meta-head"><p style="color:white;"><?php echo $lang['inv-shipping6'] ?></p></td>
                <td style="border: 2px">
                    <?php if($met_payment!=null){ echo $met_payment->met_payment;} ?>
                </td>   
            </tr>
            <tr >
                <td style="border-bottom:  2px" class="meta-head"><p style="color:white;"><?php echo $lang['inv-shipping7'] ?></p></td>
                <td style="border: 2px"><?php echo $courier_com->name_com; ?></td>
            </tr>
            <tr >
                <td  style="border-bottom:  2px"class="meta-head"><p style="color:white;"><?php echo $lang['inv-shipping8'] ?></p></td>
                <td style="border: 2px"><?php echo $fecha; ?></td>
            </tr>
            <tr>
                <td style="border-bottom:  2px;" class="meta-head"><p style="color:white;"><?php echo $lang['inv-shipping9'] ?>.</p></td>
                <td style="border: 2px"><b><?php echo $row->order_prefix.$row->order_no; ?></b></td>
            </tr>
        </table>
 ...
 -->
     <table id="items" style="width: 100%; border-collapse: collapse; margin-right:  5px">
        ...
        foreach ($order_items as $row_item){
            ...
            $db->query("SELECT * FROM category where id= '".$row_item->order_item_category."'"); 
           ...
           $total_envio = ($sumador_total-$total_descuento)+ $total_impuesto + $total_seguro+ $total_impuesto_aduanero + $total_valor_declarado + $row->total_reexp;
            ...
            <tr class="item-row">
                <td style=" border: 1px solid black; padding: 3px;"><?php echo $row_item->order_item_quantity; ?></td>
                <td style=" border: 1px solid black; padding: 3px;"><?php echo $description_item; ?></td>
                <td style=" border: 1px solid black; padding: 3px;"><?php echo $category_item; ?></td>
                <td style=" border: 1px solid black; padding: 3px;"><?php echo $weight_item; ?></td>
                <td style=" border: 1px solid black; padding: 3px;"><?php echo $row_item->order_item_length; ?></td>
                <td style=" border: 1px solid black; padding: 3px;"><?php echo $row_item->order_item_width; ?></td>
                <td style=" border: 1px solid black; padding: 3px;"><?php echo $row_item->order_item_height; ?></td>
                <td style=" border: 1px solid black; padding: 3px;"><?php echo $total_metric; ?></td>
                <td style=" border: 1px solid black; padding: 3px;"><?php echo $row_item->order_item_declared_value; ?></td>
        ...
        <tr class="">                                   
            <td style=" border: 1px solid black; padding: 3px;" colspan="2"></td>
            <td style=" border: 1px solid black; padding: 3px;"></td>
            <td style=" border: 1px solid black; padding: 3px;"></td>
            <td style=" border: 1px solid black; padding: 3px;"></td>
            <td style=" border: 1px solid black; padding: 3px;"  colspan="3" class="text-right"><b><?php echo $lang['left240'] ?></b></td>
            <td style=" border: 1px solid black; padding: 3px;" class="text-center"><?php echo $sumador_total; ?></td>              
            
        </tr>

        <tr class="">                                   
            <td style=" border: 1px solid black; padding: 3px;" colspan="2"><b>Price Lb:</b> <?php echo $row->value_weight;?></td>
            <td style=" border: 1px solid black; padding: 3px;"></td>
            <td style=" border: 1px solid black; padding: 3px;"></td>
            <td style=" border: 1px solid black; padding: 3px;"></td>
            <td style=" border: 1px solid black; padding: 3px;"  colspan="3" class="text-right"><b>Discount <?php echo $row->tax_discount; ?> %< </b></td>
            <td style=" border: 1px solid black; padding: 3px;" class="text-center"><?php echo $total_descuento; ?></td>              
            
        </tr>

        <tr>                
            <td style=" border: 1px solid black; padding: 3px;" colspan="2"><b><?php echo $lang['left232'] ?>:</b> <span id="total_libras"><?php echo $sumador_libras; ?></span></td>
            <td style=" border: 1px solid black; padding: 3px;"></td>
            <td style=" border: 1px solid black; padding: 3px;"></td>                                                                             
            <td style=" border: 1px solid black; padding: 3px;"></td>                                                                             
            <td style=" border: 1px solid black; padding: 3px;"  colspan="3" class="text-right"><b>Shipping insurance <?php echo $row->tax_insurance_value; ?> % </b></td>
            <td style=" border: 1px solid black; padding: 3px;" class="text-center" id="insurance"><?php echo $total_seguro; ?></td>              
                                                         
        </tr>

        <tr>
            <td style=" border: 1px solid black; padding: 3px;" colspan="2"><b><?php echo $lang['left234'] ?>:</b> <span id="total_volumetrico"><?php echo $sumador_volumetric; ?></span></td>                                            
            <td style=" border: 1px solid black; padding: 3px;"></td>
            <td style=" border: 1px solid black; padding: 3px;"></td>
            <td style=" border: 1px solid black; padding: 3px;"></td>
            <td style=" border: 1px solid black; padding: 3px;"  colspan="3" class="text-right"> <b>Customs tariffs <?php echo $row->tax_custom_tariffis_value; ?> %</b></td>
            <td style=" border: 1px solid black; padding: 3px;" class="text-center" id="total_impuesto_aduanero"><?php echo $total_impuesto_aduanero; ?></td>              
                                                        

        </tr>

        <tr>                
            <td style=" border: 1px solid black; padding: 3px;" colspan="2"><b><?php echo $lang['left236'] ?></b>: <span id="total_peso"><?php echo $total_peso; ?></span></td>                          
            <td style=" border: 1px solid black; padding: 3px;"></td>
            <td style=" border: 1px solid black; padding: 3px;"></td>
            <td style=" border: 1px solid black; padding: 3px;"></td>
            <td style=" border: 1px solid black; padding: 3px;"  colspan="3" class="text-right"><b>Tax <?php echo $row->tax_value; ?> % </b></td>
            <td style=" border: 1px solid black; padding: 3px;" class="text-center" id="impuesto"><?php echo $total_impuesto; ?></td> 
         ...
         <tr>                
            ...
            <td style=" border: 1px solid black; padding: 3px;"></td>
            <td style=" border: 1px solid black; padding: 3px;"></td>
            <td style=" border: 1px solid black; padding: 3px;"  colspan="3" class="text-right"><b>Declared tax <?php echo $row->declared_value; ?> %</b></td>
            <td style=" border: 1px solid black; padding: 3px;" class="text-center" id="impuesto"><?php echo $total_valor_declarado; ?></td> 
        ...
        <tr>                                            
            ...
            <td style=" border: 1px solid black; padding: 3px;"></td>
            <td style=" border: 1px solid black; padding: 3px;"></td>
            <td style=" border: 1px solid black; padding: 3px;"  colspan="3" class="text-right"><b><?php echo $lang['add-title44'] ?> &nbsp; <?php echo $core->currency;?></b></td>
            <td style=" border: 1px solid black; padding: 3px;" class="text-center" id="total_envio"><?php echo $total_envio; ?></td>              
      ...
      <table cellspacing="10" style="width: 100%; text-align: left; font-size: 11pt;">
             ...
             <tr>
               ...
               <?php echo $core->signing_customer;?></td>
            </tr>
        </table>
