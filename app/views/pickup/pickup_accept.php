...
// *************************************************************************
    ...
    $db= new Conexion;
            ...
            $db->bind(':sub_total',  trim($_POST["subtotal_input"]));
            $db->bind(':tax_discount',  floatval($_POST["discount_value"]));
            $db->bind(':total_tax_discount',  floatval($_POST["discount_input"]));
            $db->bind(':total_tax_insurance',  trim($_POST["insurance_input"]));
            $db->bind(':total_tax_custom_tariffis',  trim($_POST["total_impuesto_aduanero_input"]));
            $db->bind(':total_tax',  trim($_POST["impuesto_input"]));
            $db->bind(':total_order',  trim($_POST["total_envio_input"]));
            ...
            $db->bind(':user_id',  $_SESSION['userid']);
            $db->bind(':order_id',  $order_id);       
            $db->bind(':notification_description','There is a pickup has been accepted, please check it');           
            ...
            insertNotificationsUsers($notification_id, $sender_data->id); 
...
<body>
    ...
    <div id="main-wrapper">
        ...
        <?php $statusrow = $core->getStatusPickup(); ?>
                                                    ...
                                                    <div class="input-group">
                                                        <select class="custom-select col-12 order_item_category<?php echo $count_item;?>" id="order_item_category<?php echo $count_item;?>" name="order_item_category[]" required>
                                                            ...
                                                            ?>
                                                                ...
                                                                <?php if($row->id==$row_item->order_item_category){echo 'selected';}  ?> ><?php echo $row->name_item; ?></option>
                                                            <?php endforeach;?>
                                                        </select>
                                                    </div>
                                            </div>
                                ...
                                <table id="invoice-item-table" class="table">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr class="card-hover">                
                                            ...
                                            <td  colspan="2" >                                                
                                                <input type="text"  onkeypress="return soloNumeros(event)"  onblur="cal_final_total();" class="form-control form-control-sm" value="<?php echo $core->declared_tax;?>" name="declared_value_tax" id="declared_value_tax">
                                            </td>
