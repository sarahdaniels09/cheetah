										...
										<div class="card-body">
												...
												<div class="d-flex">
													<div class="mr-auto">
														<div class="form-group">
															<a href="incoterms_add.php"><button type="button" class="btn btn-primary btn"><i class="ti-plus" aria-hidden="true"></i> <?php echo $lang['tools-incoterms14'] ?></button></a>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="col-md-4 pull-right m-b-20">
						  				      ...
						  				      <div class="input-group input-group">
							                      ...
							                      <input type="text" name="search" id="search" class="form-control input-sm float-right" placeholder="search incoterms"  onkeyup="load(1);">
