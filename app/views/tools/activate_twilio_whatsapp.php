			...
			<div class="right-part mail-list bg-white">
				<div class="p-15 b-b">
					<div class="d-flex align-items-center">
						<div>
							<span>Activate Twilio Whatssap</span>
						</div>
							...
							<div class="col-12">
								<div class="card-body">
									...
									<form class="form-horizontal form-material" id="save_data" name="save_data" method="post">
										<header><b>Twilio Whatssap settings</b></header> <br><br>
										<section>
											<div class="row">
							                                ...
							                                <tr class="card-hover">			                                    
							                                    <td class="" colspan="4">
						                                    		<div class="form-group">
																	 	<label class="custom-control custom-checkbox" style="font-size: 18px;"> <b>Twilio Whatssap</b>
									                                	</label>
																	</div>
							                                    </td>
							                                    ...
							                                    <td class="">
						                                    		<div class="form-group">
									                                    ...
									                                    <input type="checkbox" class="custom-control-input" name="active_whatsapp" id="active_whatsapp" value="1" <?php if($core->active_whatsapp==1){ echo 'checked'; }?>>
