						...
						<div class="card">
							<div class="card-body">
								...
								<form class="form-horizontal form-material" id="update_data" name="update_data" method="post">
									<header><?php echo $lang['tools-category1'] ?> <span><?php echo $lang['tools-category2'] ?> <i class="icon-double-angle-right"></i> <?php echo $row_item->name_item;?></span></header> <br> <br>
									<section>
										<div class="row">
											<div class="col-md-12">
