			 ...
			 <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <span><?php echo $lang['tools-config61'] ?> | <?php echo $lang['tools-category10'] ?></span>
						...
						<div class="card">
							<div class="card-body">
								...
								<form class="form-horizontal form-material" id="save_data" name="save_data" method="post">
									<header><?php echo $lang['tools-category6'] ?> <span><?php echo $lang['tools-category7'] ?></span></header> <br><br>
									<section>
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<label for="firstName1"><?php echo $lang['tools-category6'] ?></label>
													<input type="text" class="form-control" name="name_item" id="name_item" placeholder="<?php echo $lang['tools-category6'] ?>">
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<label for="lastName1"><?php echo $lang['tools-category8'] ?></label>
													<textarea class="form-control" rows="2" type="text" name="detail_item" id="detail_item" placeholder="<?php echo $lang['tools-category8'] ?>"></textarea>
												</div>
											</div>
										</div>
									</section>	
