						...
						<div class="card">
							<div class="card-body">
								...
								<form class="form-horizontal form-material" id="save_data" method="post">
									<header><?php echo $lang['tools-methodpay6'] ?> <span><?php echo $lang['tools-methodpay7'] ?></span></header> <br><br>
									<section>
										<div class="row">
											<div class="col-md-6">
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="number" class="form-control" name="detail" id="detail" placeholder="Days">
												</div>
											</div>
										</div>
									</section>	
