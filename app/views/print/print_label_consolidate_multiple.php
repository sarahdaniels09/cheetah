		...
		<?php
			...
			if (isset($_GET['data'])) {
			    ...
			    foreach ($data as $key) {
			    	...
			    	$data_key= getConsolidatePrintMultiple($key);			
					...
					<td>						
						<table style="text-align: center; table-layout:fixed;"   cellspacing="2" width="100%">
							<tbody>
								<tr>
									<td width="75%">
										<p style="text-align: left;"><font size=6 face="arial"><strong><?php echo $order_service_options->ship_mode; ?></strong></font></p>										
									</td>
									<td width="25%">
						...
						<table  width="100%" style="text-align: center; table-layout:fixed;">
							<tbody>
								...
								<tr>
									...
									<td>
										<p style="text-align: left;"><font size="4"><b>&nbsp;&nbsp;&nbsp; <?php echo $receiver_data->fname.' '.$receiver_data->lname;?></b></font></p>
										...
										<p style="text-align: left;"><font size=5><strong>&nbsp;&nbsp;<?php echo $address_order->recipient_country; ?></strong></font></p>
									</td></font>
								</tr>
							</tbody>
						</table>
							...
							<tbody>
								<tr>
									<td width="50%">
										...
										<p><font size=4><b><?php echo $delivery_time->delitime; ?></b></font></p>
									</td>
									<td width="50%">
										<p><strong><?php echo $lang['inv-label5'] ?></strong></p>
										<p><font size=4><strong><b><?php echo $courier_com->name_com; ?></b></strong></p>
									</td>
								</tr>
						  </tbody>
					  </table>
					  ...
					  <center  width="100%">
						<div class="output">
						  ...
						  <img src='https://barcode.tec-it.com/barcode.ashx?data=<?php echo $row_order->c_prefix.$row_order->c_no; ?>&code=Code39&multiplebarcodes=false&translate-esc=false&unit=Fit&dpi=150&imagetype=Gif&rotation=0&color=%23000000&bgcolor=%23ffffff&qunit=Mm&quiet=0&modulewidth=50' alt='<?php echo $row_order->c_prefix.$row_order->c_no; ?>'/></section>
						</div>
					  </center>
