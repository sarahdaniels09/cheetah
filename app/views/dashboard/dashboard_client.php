                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div><span>Consolidated</span>
                                                <h3 class="font-medium m-b-0">
                                                    ...
                                                    $db->query("SELECT COUNT(*) as total FROM consolidate WHERE sender_id='".$_SESSION['userid']."'");
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div><span>Shipments consolidated</span>
                                                <h3 class="font-medium m-b-0">
                                                    ...
                                                    $db->query("SELECT COUNT(*) as total FROM add_order WHERE  is_consolidate=1 and sender_id='".$_SESSION['userid']."'");
