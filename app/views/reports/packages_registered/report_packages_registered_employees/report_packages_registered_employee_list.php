...
// *************************************************************************
    ...
    $usersEmployeeAdmin = $core->getUsersEmployeedAdmin();
...
<head>
    ...
    <title>Packages Registered report by employee</title>
    <!-- This Page CSS -->
    <!-- Custom CSS -->
...
<body>
            	...
            	<div class="row">
					...
					<div class="col-lg-12 col-xl-12 col-md-12">
                        <div class="row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        <div class="input-group">                                       
                                            <select onchange="load(1);" class="form-control custom-select " id="employee_id" name="employee_id" >
                                            <option value="0">Select employee</option>
                                            <?php foreach ($usersEmployeeAdmin as $row):?>                                            
						...
						<div class="card card-outline">
                            <h4 class="card-title  ml-4 mt-3"> Packages Registered report by employee</h4>
	...
	<script src="dataJs/report_packages_registered_employees.js"></script> 
