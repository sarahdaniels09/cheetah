...
<head>
    ...
    <title>Consolidated report general</title>
    <!-- This Page CSS -->
    <!-- Custom CSS -->
...
<body>
            	...
            	<div class="row">
					...
					<div class="col-lg-12 col-xl-12 col-md-12">
						...
						<div class="card card-outline">
                            <h4 class="card-title  ml-4 mt-3"> Consolidated report general</h4>
	...
	<script src="dataJs/report_consolidate_general.js"></script> 
