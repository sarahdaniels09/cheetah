...
// *************************************************************************
    ...
    $agencyrow = $core->getBranchoffices(); 
...
<head>
    ...
    <title>Shipment report general</title>
    <!-- This Page CSS -->
    <!-- Custom CSS -->
...
<body>
					...
					<div class="col-lg-12 col-xl-12 col-md-12">
                        <div class="row mb-4">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="col-md-2">
                                            <select class="select2 form-control   " style="width: 100%; height:36px;"  id="customer_id" name="customer_id"  onchange="load(1);">
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-12 col-md-2">
                                        <div class="input-group">                                       
                                            <select onchange="load(1);" class="form-control custom-select " id="agency" name="agency" >
                                    ...
                                    <div class="col-sm-12 col-md-2">
                                        <div class="input-group">                                       
                                            <select onchange="load(1);" class="form-control custom-select " id="method" name="method" >
                                    ...
                                    <div class="col-sm-12 col-md-2">
                                        <div class="btn-group pull-right">
                                            <button onclick="exportPrint();"  class="btn waves-effect waves-light btn-secondary mr-2"><i class='fa fa-print'></i> Print</button>           
                                            <button onclick="exportExcel();"  class="btn waves-effect waves-light btn-secondary"><i class=' fas fa-file-excel'></i> Export Excel</button> 
                                       </div>
                                    </div>
						...
						<div class="card card-outline">
                            <h4 class="card-title  ml-4 mt-3"> Shipment report general</h4>
	...
	<script src="dataJs/report_general.js"></script> 
