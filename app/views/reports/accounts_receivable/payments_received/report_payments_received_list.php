...
<head>
    ...
    <title>Payments received report</title>
    <!-- This Page CSS -->
    <!-- Custom CSS -->
...
<body>
					...
					<div class="col-lg-12 col-xl-12 col-md-12">
                        <div class="row mb-4">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">                                       
                                            <select onchange="load(1);" class="form-control custom-select " id="pay_mode" name="pay_mode" >
						...
						<div class="card card-outline">
                            <h4 class="card-title  ml-4 mt-3"> Payments received report</h4>
	...
	<script src="dataJs/report_payments_received.js"></script> 
