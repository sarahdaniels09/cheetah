...
// *************************************************************************
    ...
    if (isset($_GET['recipient'])) {
        $data= getRecipientEdit($_GET['recipient']);
    }

    if (!isset($_GET['recipient']) or $data['rowCount']!=1){
        redirect_to("recipients_list.php");
    }

    $row_recipient=$data['data'];

    $db->query("SELECT * FROM users_multiple_addresses WHERE user_id='".$_GET['recipient']."'"); 
    $recipient_addreses= $db->registros();
                                    ...
                                    <!-- <div id="loader" style="display:none"></div> -->
                                        ...
                                        <form class="form-horizontal form-material" id="save_user" name="save_user" method="post">
                                            <section>
                                                ...
                                                foreach ($recipient_addreses as $row){
                                                ...
                                                <h4><?php echo $lang['laddress']; echo ' '.$count; ?> </h4>

                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="phoneNumber1"><?php echo $lang['user_manage10'] ?></label>
                                                            <input type="text" class="form-control" name="address[]"  id="address<?php echo $count;?>"placeholder="<?php echo $lang['user_manage10'] ?>" value="<?php echo $row->address;?>">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="country[]"  id="country<?php echo $count;?>" placeholder="<?php echo $lang['user_manage12'] ?>" value="<?php echo $row->country;?>" >
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="city<?php echo $count;?>" name="city[]" placeholder="<?php echo $lang['user_manage13'] ?>" value="<?php echo $row->city;?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="phoneNumber1"><?php echo $lang['user_manage14'] ?></label>
                                                            <input type="text" class="form-control" name="postal[]" id="postal<?php echo $count;?>" placeholder="<?php echo $lang['user_manage14'] ?>" value="<?php echo $row->zip_code;?>">
                                                        </div>
                                                    </div>
                                                </div>
