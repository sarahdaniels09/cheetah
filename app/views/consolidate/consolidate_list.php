...
<head>
    ...
    <title>consolidated list | <?php echo $core->site_name ?></title>
    <!-- This Page CSS -->
    <!-- Custom CSS -->
			 ...
			 <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title"> consolidated list</h4>
								...
								<!-- <div class="m-t-40">
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class=" col-sm-12 col-md-2 offset-7">
                                            ...
                                            <div class="form-group">
                                                <a href="consolidate_add.php"><button type="button" class="btn btn-primary "><i class="ti-plus" aria-hidden="true"></i> Create consolidated</button></a>
                                            </div> 
                                        </div>
                                    <?php } ?>
