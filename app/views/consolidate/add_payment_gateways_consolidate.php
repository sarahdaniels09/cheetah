...
// *************************************************************************
    ...
    if (isset($_GET['id_order'])) {
        $data= getConsolidatePrint($_GET['id_order']);
    }
    ...
    $track_order = $row_order->c_prefix.$row_order->c_no;
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-lg-12 mx-auto text-center">
                                            <h3 class="display-7"><b class="text-danger">INVOICE</b> <span>#<?php echo $row_order->c_prefix.$row_order->c_no;?></span></h3>
                                        </div>
     ...
     <script type="text/javascript">
        ...
        function addPaymentPayPalSuccess(details){
            ...
            $.ajax({
                ...
                url:'./ajax/consolidate/add_payment_paypal_method_ajax.php?order_id=<?php echo $_GET['id_order'];?>&track_order=<?php echo $track_order; ?>&customer=<?php echo $row_order->sender_id; ?>',
                method:'post',
                data: details,                       
...
document.querySelector("button").disabled = true;
    ...
    fetch("./ajax/consolidate/add_payment_stripe_method_ajax.php", {
      method: "POST",
      headers: {
...
var loading = function(isLoading) {
 ...
 function addPaymentStripeSuccess(details){
    ...
    $.ajax({
        ...
        url:'./ajax/consolidate/add_payment_stripe_method_success_ajax.php?order_id=<?php echo $_GET['id_order'];?>&track_order=<?php echo $track_order; ?>&customer=<?php echo $row_order->sender_id; ?>',
        method:'post',
        data: details,                       
        success:function(data){
...
function redirect() {
    window.location = "consolidate_view.php?id=<?php echo $_GET['id_order']; ?>";
}
...
$( "#add_charges" ).submit(function( event ) {
    ...
    $.ajax({
        type: "POST",
        url: "./ajax/consolidate/consolidate_add_payment_doc_ajax.php?order_id=<?php echo $_GET['id_order']; ?>",
        data: data,
...
<script type="text/javascript">
    ...
    function addPaymentPaystackSuccess(details){
        ...
        $.ajax({
            ...
            url:'./ajax/consolidate/add_payment_paystack_method_success_ajax.php?order_id=<?php echo $_GET['id_order'];?>&track_order=<?php echo $track_order; ?>&customer=<?php echo $row_order->sender_id; ?>&firstname='+firstname+'&lastname='+lastname,
            method:'post',
            data: details,                       
            success:function(data){
