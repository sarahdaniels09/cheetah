            ...
            <div class="container-fluid">
                                        ...
                                        <div class="btn-group pull-right">
                                            ...
                                            <div class="dropdown-menu scrollable-menu">
                                                ...
                                                <?php if ($row_order->status_invoice ==2) {?>
                                                    ...
                                                    <a 
                                                        class="dropdown-item" 
                                                        href="add_payment_gateways_consolidate.php?id_order=<?php echo $row_order->consolidate_id;?>">
                                                ...
                                                <?php if ($userData->userlevel !=1) {?>
                                                    ...
                                                    data-id="<?php echo $row_order->consolidate_id;?>"
                                                ...
                                                data-order="<?php echo $row_order->c_prefix.$row_order->c_no;?>"
                ...
                <?php 
                    if ($row_order->status_courier==8){
                        ...
                        $db->query("SELECT * FROM courier_track where order_track='".$row_order->c_prefix.$row_order->c_no."' and status_courier=8"); 
                ...
                $db->query("SELECT * FROM courier_track where order_track='".$row_order->c_prefix.$row_order->c_no."' ORDER BY t_date"); 
                ...
                $db->query("SELECT * FROM order_user_history where order_id='".$_GET['id']."' and is_consolidate='1' ORDER BY history_id"); 
                                        ...
                                        if($order_items){
                                            ...
                                            foreach ($order_items as $row_order_item){
                                                ...
                                                <tr class="card-hover">
                                                    ...
                                                    <td colspan="3" class="text-right"><?php echo $row_order_item->weight_vol; ?></td>
                                                    <td></td>
