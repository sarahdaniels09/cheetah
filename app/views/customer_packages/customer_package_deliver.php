...
// *************************************************************************
    ...
    if(isset($_POST['person_receives'])){
        ...
        if (empty($errors)) {
            ...
            $db->query('UPDATE customers_packages SET    
            ...
            $email_template =getEmailTemplates(23);
                        ...
                        <div class="card">
                                    ...
                                    <div id="resultados_ajax">
                                        ...
                                        <form name="myForm" class="xform" enctype="multipart/form-data" id="deliver_form" method="POST">
                                            <header><h4 class="modal-title"> <b class="text-danger">Package tracking </b> <b>| #<?php echo $row->order_prefix.$row->order_no;?></b>
