...
// *************************************************************************
	...
	$userData = $user->getUserData();
        ...
        $sql_customer="SELECT * FROM users where id= '".$data->sender_id."'			
			 ";


        $db->query($sql_customer); 
        $customer= $db->registro();
		...
		$sql_charge="SELECT * FROM charges_order where id_charge= '".$id_charge."' ";
			...
			<div class="row">
			  ...
			  <div class="row">
				<div class="form-group col-sm-12">
				  ...
				  <input type="text" onkeypress="return soloNumeros(event)" class="form-control" id="total_pay" name="total_pay" placeholder="" required value="<?php echo $charges->total;?>">
				</div>
			  </div>
				   ...
				   <div class="form-group col-md-12">
	                    ...
	                    <div class="input-group mb-3">                                       
	                        ...
	                        <?php foreach ($payrow as $row):?>
	                            <option value="<?php echo $row->id; ?>" <?php if($row->id == $charges->payment_type){echo 'selected';} ?> ><?php echo $row->met_payment; ?></option>
	                        <?php endforeach;?>
	                        </select>
	                    </div>
	                </div> 
