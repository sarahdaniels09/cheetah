		...
		<thead>
			...
			<tr>
				...
				<td class="text-center">
					...
					<a id="item_<?php echo $row->id;?>" onclick="eliminar('<?php echo $row->id;?>');" class="delete" data-rel="<?php echo $row->name_pack;?>" data-toggle="tooltip" data-original-title="<?php echo $lang['tools-packaging16'] ?>"><i class="ti-close" aria-hidden="true"></i></a>
				</td>
			</tr>
			<?php }?>
