...
// *************************************************************************
   ...
   require_once ("../../helpers/querys.php");
      ...
      if (empty($_POST['min_cost_tax']))

        $errors['min_cost_tax'] = "Please enter Minimum cost to apply tax!";    
          ...
          if (empty($errors)) {
              ...
              $data = array(
                  ...
                  'tax' => trim($_POST['tax']),
                  'min_cost_tax' => trim($_POST['min_cost_tax']),
                  'min_cost_declared_tax' => trim($_POST['min_cost_declared_tax']),
                  'declared_tax' => trim($_POST['declared_tax']),
                  'insurance' => trim($_POST['insurance']),
                  'value_weight' => trim($_POST['value_weight']),
                  'meter' => trim($_POST['meter']),                  
                  'c_tariffs' => trim($_POST['c_tariffs']),
              );                
           
            
            $insert= updateConfigTaxes($data);
