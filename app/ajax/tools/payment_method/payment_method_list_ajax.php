	...
	<table id="zero_config" class="table table-condensed table-hover table-striped" data-pagination="true" data-page-size="5">
		<thead>
			<tr>
				...
				<th data-sort-ignore="true" ><b>Days</b></th>
			...
			<tr>
				...
				?>
					<a href="payment_methods_edit.php?id=<?php echo $row->id;?>" data-toggle="tooltip" data-original-title="<?php echo $lang['tools-methodpay16'] ?>"><i class="ti-pencil" aria-hidden="true"></i></a>
					<a id="item_<?php echo $row->id;?>" onclick="eliminar('<?php echo $row->id;?>');" class="delete" data-rel="<?php echo $row->label;?>" data-toggle="tooltip" data-original-title="<?php echo $lang['tools-methodpay17'] ?>"><i class="ti-close" aria-hidden="true"></i></a>
				<?php }?>
				</td>
