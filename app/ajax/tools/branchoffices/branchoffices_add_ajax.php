...
// *************************************************************************
   ...
   require_once ("../../../helpers/querys.php");
        ...
        if (branchofficeExists($_POST['name_branch']))
        ...
        if (empty($_POST['phone_branch']))
          ...
          if (empty($errors)) {
            ...
            $data = array(
              'name_branch' => trim($_POST['name_branch']), 
              'branch_address' => trim($_POST['branch_address']), 
              'branch_city' => trim($_POST['branch_city']),
              'phone_branch' => trim($_POST['phone_branch'])
            );
            
            $insert= insertBranchOffices($data);

            if ($insert) {

                $messages[] = "New branch Office added successfully!";
