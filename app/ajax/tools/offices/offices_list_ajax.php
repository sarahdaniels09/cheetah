		...
		<thead>
			...
			<tr>
				...
				<td class="text-center">
					...
					<a onclick="eliminar('<?php echo $row->id;?>')" id="item_<?php echo $row->id;?>" class="delete" data-rel="<?php echo $row->name_off;?>"  data-toggle="tooltip" data-original-title="<?php echo $lang['tools-office22'] ?>"><i class="ti-close" aria-hidden="true"></i></a>
				</td>
			</tr>
			<?php }?>
