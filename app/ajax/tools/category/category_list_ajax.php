...
// *************************************************************************
	...
	$db = new Conexion;
        ...
        // if($search!=null){
			...
			$sWhere.=" name_item LIKE '%".$search."%'";
        // }


		$sWhere.=" order by name_item desc";
		...
		<thead>
			...
			<tr>
				...
				<td class="text-center">
					<a href="category_edit.php?id=<?php echo $row->id;?>" data-toggle="tooltip" data-original-title="<?php echo $lang['tools-category15'] ?>"><i class="ti-pencil" aria-hidden="true"></i></a>
					
					<a id="item_<?php echo $row->id;?>" onclick="eliminar('<?php echo $row->id;?>');" class="delete" data-rel="<?php echo $row->name_item;?>" data-toggle="tooltip" data-original-title="<?php echo $lang['tools-category16'] ?>"><i class="ti-close" aria-hidden="true"></i></a>
				</td>
			</tr>
			<?php }?>
