...
// *************************************************************************
	...
	// var_dump($gateway);
		...
		$sql="SELECT * FROM	 payments_gateway  where type_transaccition_courier= 'Online Shipping' and payment_transaction LIKE '%".$search."%' $sWhere  order by id desc 
			 ";
	...
	<table id="zero_config" class="table table-condensed table-hover table-striped custom-table-checkbox">
		...
		<tbody id="projects-tbl">
			...
			?>
						...
						<td><b><a  href="customer_packages_view.php?id=<?php echo $order_->order_id;?>"><?php echo $row->order_track;?></a></b></td>
