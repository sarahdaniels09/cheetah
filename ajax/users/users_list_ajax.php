	...
	<table id="zero_config" class="table table-condensed table-hover table-striped" data-pagination="true" data-page-size="5">
		<thead>
			...
			<tr>
				...
				<td class="text-center"><?php echo userStatus($user->active, $user->id);?></td>
				<td class="text-center"><?php echo isAdmin($user->userlevel);?></td>
				...
				<td align='center'>
					...
					<?php else:?>
					<a  onclick="eliminar('<?php echo $user->id;?>')" id="item_<?php echo $user->id;?>"   data-rel="<?php echo $user->username;?>" class="delete" data-toggle="tooltip" data-placement="top" title="<?php echo $lang['edit-clien47'] ?>"><i style="color:#343a40" class="ti-trash"></i></a>
					<?php endif;?>
				</td>
			</tr>
			<?php }?>
