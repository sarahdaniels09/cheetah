...
// *************************************************************************
   ...
   require_once ("../../../helpers/querys.php");
       ...
       if (empty($_POST['name_com']))
        ...
        if (courierExists($_POST['name_com'], $_POST['id']))
      ...
      if (empty($_POST['postal_cou']))
          ...
          if (empty($errors)) {
            ...
            $data = array(
              'name_com' => trim($_POST['name_com']), 
              'address_cou' => trim($_POST['address_cou']), 
              'phone_cou' => trim($_POST['phone_cou']), 
              'country_cou' => trim($_POST['country_cou']), 
              'city_cou' => trim($_POST['city_cou']),
              'postal_cou' => trim($_POST['postal_cou']),
              'id' => trim($_POST['id'])
            );
            
            $insert= updateCourierCompany($data);

            if ($insert) {

                $messages[] = "New Courier Company updated successfully!";
