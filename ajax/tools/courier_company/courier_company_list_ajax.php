...
// *************************************************************************
	...
	$db = new Conexion;
        ...
        // if($search!=null){
			...
			$sWhere.=" name_com LIKE '%".$search."%'";
        // }


		$sWhere.=" order by name_com desc";
		...
		<thead>
			...
			<tr>
				...
				<td class="text-center">
					<a href="courier_company_edit.php?id=<?php echo $row->id;?>" data-toggle="tooltip" data-original-title="<?php echo $lang['tools-courier26'] ?>"><i class="ti-pencil" aria-hidden="true"></i></a>
					<a id="item_<?php echo $row->id;?>"onclick="eliminar('<?php echo $row->id;?>');" class="delete" data-rel="<?php echo $row->name_off;?>" data-toggle="tooltip" data-original-title="<?php echo $lang['tools-courier27'] ?>"><i class="ti-close" aria-hidden="true"></i></a>
				</td>
			</tr>
			<?php }?>
