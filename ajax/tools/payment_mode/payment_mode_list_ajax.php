...
// *************************************************************************
	...
	$db = new Conexion;
        ...
        // if($search!=null){
			...
			$sWhere.=" met_payment LIKE '%".$search."%'";
        // }


		$sWhere.=" order by met_payment desc";
		...
		<thead>
			...
			<tr>
				...
				<td class="text-center">
					<a href="payment_mode_edit.php?id=<?php echo $row->id;?>" data-toggle="tooltip" data-original-title="<?php echo $lang['tools-methodpay16'] ?>"><i class="ti-pencil" aria-hidden="true"></i></a>
					<a id="item_<?php echo $row->id;?>" onclick="eliminar('<?php echo $row->id;?>');" class="delete" data-rel="<?php echo $row->met_payment;?>" data-toggle="tooltip" data-original-title="<?php echo $lang['tools-methodpay17'] ?>"><i class="ti-close" aria-hidden="true"></i></a>
				</td>
			</tr>
			<?php }?>
