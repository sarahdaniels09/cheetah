...
// *************************************************************************
   ...
   require_once ("../../../helpers/querys.php");
       ...
       $errors['name_pack'] = 'Please Enter New Packaging Type';
        ...
        if (packExists($_POST['name_pack'], $_POST['id']))
      ...
      if (empty($_POST['detail_pack']))
       $errors['detail_pack'] = 'Please Enter New Details Packaging Type';
          ...
          if (empty($errors)) {
            ...
            $data = array(
              'name_pack' => trim($_POST['name_pack']), 
              'detail_pack' => trim($_POST['detail_pack']),
              'id' => trim($_POST['id'])
            );
            
            $insert= updatePackaging($data);

            if ($insert) {

                $messages[] = "New Packaging Type updated successfully!";
