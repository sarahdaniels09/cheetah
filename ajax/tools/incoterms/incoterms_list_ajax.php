		...
		<thead>
			...
			<tr>
				...
				<td class="text-center">
					<a href="incoterms_edit.php?id=<?php echo $row->id;?>" data-toggle="tooltip" data-original-title="<?php echo $lang['tools-shipline15'] ?>"><i class="ti-pencil" aria-hidden="true"></i></a>
					<a  onclick="eliminar('<?php echo $row->id;?>')" id="item_<?php echo $row->id;?>" class="delete" data-rel="<?php echo $row->inco_name;?>" data-toggle="tooltip" data-original-title="<?php echo $lang['tools-shipline16'] ?>"><i class="ti-close" aria-hidden="true"></i></a>
				</td>
			</tr>
			<?php }?>
