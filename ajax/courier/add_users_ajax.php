    ...
    $core = new Core;
        ...
        if(isset($_POST['register_customer_to_user']) && $_POST['register_customer_to_user']==1){
          ...
          if (empty($errors)) {
            ...
            $db->query("SELECT * FROM users where id= '".$recipient_id."'"); 
            $customer_data= $db->registro();        
                ...
                $db->bind(':address',  trim($_POST["address_modal_user"]));
                $db->bind(':country',  trim($_POST["country_modal_user"]));
                $db->bind(':city',  trim($_POST["city_modal_user"]));                
                $db->bind(':zip_code',  trim($_POST["postal_modal_user"]));
