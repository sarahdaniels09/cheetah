        ...
        if (!empty($_FILES['file_invoice']['name'])) {                                  
          ...
          if (empty($errors)) {
              ...
              $data = array(
                 ...
                 'tracking_prealert'   =>   trim($_POST["tracking_prealert"]),        
                 'provider_prealert'   =>   trim($_POST["provider_prealert"]),        
                 'courier_prealert'    =>   trim($_POST["courier_prealert"]),        
                 'customer_id'         =>   $_SESSION['userid'],            
                 'price_prealert'     =>   trim($_POST["price_prealert"]),        
                 'description_prealert' =>   trim($_POST["description_prealert"]),        
                 'estimated_date'      =>   trim($date),
            ...
            insertNotificationsUsers($notification_id, $_SESSION['userid']);
