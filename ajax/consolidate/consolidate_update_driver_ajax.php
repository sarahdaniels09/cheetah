  ...
  $db = new Conexion;
        $errors= array();  
          ...
          if (empty($errors)) {
            ...
            $insert= updateDriverConsolidate($data);
            ...
            if ($insert) {
                ...
                $messages[] = "Driver updated successfully!";
                            ...
                            $db->bind(':notification_description','a new driver has been assigned to the consolidated, please check it');           
                            ...
                            insertNotificationsUsers($notification_id, $_POST['id_senderclient_driver_update']);
