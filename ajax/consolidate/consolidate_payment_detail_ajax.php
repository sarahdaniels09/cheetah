...
// *************************************************************************
	...
	$userData = $user->getUserData();
		...
		$sql="SELECT * FROM consolidate   where consolidate_id = '".$order_id."' ";
    ...
    $db->query("SELECT * FROM met_payment where id= '".$data->order_pay_mode."'"); 
...
<div class="row">
   ...
   <div class="col-md-6">
        <h3 class=" pull-left"><b class="text-danger">INVOICE</b> <span>#<?php echo $data->c_prefix.$data->c_no;?></span></h3> 
   ...
   <div class="col-md-4">
    ...
    <div class="col-md-12 pt-2">
        <div class="pull-left">                                        
            <h5> &nbsp;<b>Notes</b></h5>
            <b class="text-muted  m-l-5"><?php if($data->notes!=null){echo $data->notes;} ?></b>
