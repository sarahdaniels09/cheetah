...
function load(page){
	...
	$("#loader").fadeIn('slow');
	$.ajax({
		url:'./ajax/tools/payment_mode/payment_mode_list_ajax.php',
		data: parametros,
              ...
              buttons: [{
              	...
              	callback: function (val) {
                  	if (val === 'Y') {
                      	$.ajax({
                          type: 'post',
                          url:'./ajax/tools/payment_mode/payment_mode_delete_ajax.php',
                          data: {		                          	
							  'id': id,								  
						  },
                          beforeSend: function () {
...
$( "#save_data" ).submit(function( event ) {
	...
	$.ajax({
			type: "POST",
			url: "ajax/tools/payment_mode/payment_mode_add_ajax.php",
			data: parametros,			
			 beforeSend: function(objeto){
...
$( "#update_data" ).submit(function( event ) {
	...
	$.ajax({
			type: "POST",
			url: "ajax/tools/payment_mode/payment_mode_edit_ajax.php",
			data: parametros,			
			 beforeSend: function(objeto){
				$("#resultados_ajax").html("Please wait...");
			  },
